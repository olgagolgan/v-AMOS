...
# setting the environment for testing, the endpoint and path has been commented in order to allow the user to set them
# wherever he/she want, either here or in the triplestore or relational processors pages

# # endpoint = TriplestoreProcessor.setEndpointUri()
trp = TriplestoreProcessor.getEndPoint()
trp_qp = TriplestoreQueryProcessor(trp)

# path = RelationalProcessor.setDbPath()
